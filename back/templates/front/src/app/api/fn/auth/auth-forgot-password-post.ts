...
export function authForgotPasswordPost(http: HttpClient, rootUrl: string, params?: AuthForgotPasswordPost$Params, context?: HttpContext): Observable<StrictHttpResponse<string>> {
